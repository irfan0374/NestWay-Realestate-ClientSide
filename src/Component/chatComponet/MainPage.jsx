        ...
        <>
            <div className='flex space-x-1'>
                ...
                <aside
                    ...
                    className=" hidden fixed w-1/5 h-screen transition-transform -translate-x-full sm:translate-x-0 sticky md:block"
                    aria-label="Sidebar"
                >
                    <div className="h-full py-3 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                                    ...
                                    <div className="avatar placeholder">
                                        <div className="bg-neutral text-neutral-content rounded-full w-12">
                                            ...
                                            className='object-cover' 
                                                src={data?.profile?data?.profile:'/src/assets/Account.png'}
                                            />
                                        </div>
                                    </div>
                                    <span className="ms-3 text-sm">{data?.name}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
